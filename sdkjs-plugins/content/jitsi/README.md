...
The plugin is compatible with the [self-hosted](https://github.com/UnivaultOffice/DocumentServer) versions of UNIVAULTOFFICE editors. It can be added to UNIVAULTOFFICE instances manually.

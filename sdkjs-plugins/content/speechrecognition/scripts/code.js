...
(function(window, undefined){
	...
	window.Asc.plugin.init = function() {
		...
		if ( !isAllowed() ) {
			...
			recognition.onresult = function(event) {
				...
				if (event.results[0].isFinal && final_transcript !== '') {
					...
					window.Asc.plugin.executeMethod("PasteText",[linebreak(final_transcript)]);
					// now we will paste result as text (bug #66747).
		...
		const paragraph = '<!--StartFragment--><p style="margin-top:0pt;margin-bottom:9.999977952755906pt;border:none;mso-border-left-alt:none;mso-border-top-alt:none;mso-border-right-alt:none;mso-border-bottom-alt:none;mso-border-between:none" class="docData;DOCY;v5;2026;">&nbsp;</p><!--EndFragment-->'; 
		const two_line = /\n\n/g;
		const one_line = /\n/g;

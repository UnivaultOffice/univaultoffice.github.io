...
(function (window, undefined) {
    ...
    //         }
    //
    //         var image_url = "https://legacy-api.univaultoffice.github.io/content/img/docbuilder/examples/presentation_gun.png";
    ...
    //         oPresentation.AddSlide(oSlide);
    //         var oFill = Api.CreateBlipFill('https://legacy-api.univaultoffice.github.io/content/img/docbuilder/examples/presentation_axe.png', 'stretch');
    //         oSlide.SetBackground(oFill);
    //         oSlide.RemoveAllObjects();
    //
    ...
    //         oSlide = Api.CreateSlide();
    //         oPresentation.AddSlide(oSlide);
    //         oFill = Api.CreateBlipFill('https://legacy-api.univaultoffice.github.io/content/img/docbuilder/examples/presentation_knight.png', 'stretch');
    //         oSlide.SetBackground(oFill);
    //         oSlide.RemoveAllObjects();
    //
    //         oShape = Api.CreateShape('rect', 6904800, 1724400, Api.CreateNoFill(), Api.CreateStroke(0, Api.CreateNoFill()));
    ...
    //         oSlide = Api.CreateSlide();
    //         oPresentation.AddSlide(oSlide);
    //         oFill = Api.CreateBlipFill('https://legacy-api.univaultoffice.github.io/content/img/docbuilder/examples/presentation_sky.png', 'stretch');
    //         oSlide.SetBackground(oFill);
    //         oSlide.RemoveAllObjects();
    //
    ...
    //         oContent = oShape.GetDocContent();
    //         oContent.RemoveAllElements();
    //         addText(oShape, oContent, 'UNIVAULTOFFICE', 176, false, 'center');
